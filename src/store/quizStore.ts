...
interface QuizState {
  ...
  resetQuiz: () => void;
  buyItem: (item: 'hints' | 'timeFreezes' | 'shields' | 'sabotagers' | 'decoys' | 'ddosEmps' | 'overclocks' | 'autoSorters', cost: number) => boolean;
...
export const useQuizStore = create<QuizState>()(
  persist(
    (set, get) => ({
      ...
      coinsEarned: 0,
      xpEarned: 0,
      inventory: { hints: 0, timeFreezes: 0, shields: 0, sabotagers: 0, decoys: 0, ddosEmps: 0, overclocks: 0, autoSorters: 0 },
