    ...
    <div className="h-screen w-screen bg-[#050505] text-white font-sans overflow-y-auto flex flex-col items-center justify-center relative">
      ...
      {!isQuizActive ? (
        <>
          ...
          <Link href="/" className="fixed top-6 left-6 z-50 flex items-center gap-3 px-5 py-2.5 bg-black/50 border border-white/20 text-gray-300 hover:text-white hover:border-white/60 hover:bg-white/10 rounded-xl transition-all font-mono text-xs tracking-widest uppercase backdrop-blur-md shadow-lg">
