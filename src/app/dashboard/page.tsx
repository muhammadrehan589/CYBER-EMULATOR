...
const INITIAL_PLAYERS: LeaderboardPlayer[] = [
  ...
  { rank: 6, empId: 'EMP-199', name: 'Ali Abdul', username: 'ali199', role: 'Player', score: 3000, badgeColor: '#14b8a6' },
  { rank: 7, empId: 'EMP-101', name: 'Jang Deok-su', username: 'deoksu101', role: 'VIP', score: 2500, badgeColor: '#ef4444' },
];
